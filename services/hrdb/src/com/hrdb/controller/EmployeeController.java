...
public class EmployeeController {
    ...
    @ApiOperation(value = "Gets the employeesForManagerid instance associated with the given id.")
     public Page<Employee>
        findAssociatedEmployeesForManagerid(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the vacations instance associated with the given id.")
     public Page<Vacation>
        findAssociatedVacations(Pageable pageable, @PathVariable("id") Integer id) {
